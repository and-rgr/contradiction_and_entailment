...
# documentation:
#     huggingface.co/docs/transformers/internal/tokenization_utils#transformers.tokenization_utils_base.PreTrainedTokenizerBase.batch_encode_plus
...
# define the model?
# what does strategy.scope() do? does it help manage resources?
with strategy.scope():
